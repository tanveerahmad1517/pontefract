...
urlpatterns = [
 ...
 path(r"time/<int:year>/<int:month>/", project_views.time_month),
 path(r"time/<int:year>/<int:month>/<int:day>/", project_views.time_day),
 path(r"projects/<int:pk>/", project_views.time_projects),
